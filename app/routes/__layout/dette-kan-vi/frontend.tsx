    ...
    <>
      <Section className="md:gap-20">
        <TitleAndText title="Hvorfor frontend?" titleAs="h1">
          ...
          investere i. En god frontendopplevelse kan være forskjellen på å vinne
          og tape kunder. Har du en robust frontendløsning i dag er du godt
          rigget for å være konkurransedyktig i markedet.
        </TitleAndText>
        ...
        >
          ...
          man har for løsningen. Noen av teknologiene vi har valgt å
          spesialisere oss på er TypeScript, React, Vue og Svelte. Ikke bare er
          dette blant de rammeverkene som brukes av noen av verdens største
          selskap, som Facebook og Instagram, men er de som utvikleres og
          moderniseres raskest.
        </ContentAndImageBox>
        ...
        <ContentAndImageBox
          ...
          direction="right"
        >
          I dag skaper våre frontend utviklere kick-ass brukeropplevelser hos
          bla. Gjensidige, Amedia og NRK, og vi mener at suksessoppskriften er
          våre evner til å ta i bruk riktig rammeverk og fokus på
          fremtidsrettet, modulær og testet kode. Disse faktorene er det
          viktigste grunnlaget for å skape applikasjoner som er dynamiske,
          tilpasningsdyktige og enkle å vedlikeholde. Teknologier og
          arkitekturer er der jo bare for å tjene et større formål: å hjelpe
          brukeren å få gjort jobben sin trygt, raskt og effektivt. Og Capra har
          selvfølgelig de mest brukerorienterte frontend utviklerene som er å
          oppdrive!
        </ContentAndImageBox>
      </Section>
    </>
